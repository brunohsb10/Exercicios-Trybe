...
// Atente que, sobre o custo do produto, incide um imposto de 20%.Seu programa também deve emitir 
// uma mensagem de erro e encerrar caso algum dos seus valores de entrada seja menor que zero.
...
if (pro >= 0 && venda >= 0) {
  const totalpro = pro * 1.2;
  const lucrototal = (venda - totalpro) * 1000;
